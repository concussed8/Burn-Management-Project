...
window.location.href = `https://concussed8.github.io/Burn-Management-Project/page/ped_6_16_thermal_tbsa_and_resus.html?weight=${encodeURIComponent(weightInput)}&ts=${Date.now()}`;
    }
}
